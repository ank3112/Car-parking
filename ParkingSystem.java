...
public class ParkingSystem
{
    ...
    public static void parkCar()
    {
        ...
        availableSlots--;
        System.out.println(licensePlate +" Car parked successfully. Available slots: " + availableSlots);
    }
    ...
    public static void removeCar()
    {
        ...
        if (parkedCars.contains(licensePlate))
        {
            ...
            availableSlots++;
            System.out.println(licensePlate+ "Car removed successfully. Available slots: " + availableSlots);
        }
        else
        {
